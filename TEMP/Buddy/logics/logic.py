...
def Q_Write():
    """It will Write the Un recorded Item in the Queries.Txt file that can be further used to Modify
    and Update the ChattyBot"""
    with open("Modules/Queries.txt", 'w') as file:
        for i in query:
            file.write(str(i) + "\n")
...
class Chat(object):
    ...
    # Hold a conversation with a chatty
